      ...
      <div className="absolute inset-0 z-10 flex flex-col justify-end pb-24 md:pb-32 px-6 md:px-12 max-w-[1600px] w-full mx-auto" style={{ height: '100%' }}>
        ...
        >
          ...
          <div className="hero-meta mt-12 md:mt-24 flex flex-col md:flex-row justify-between items-start md:items-end gap-8 pt-8 relative">
            ...
            <div className="flex flex-wrap gap-3 justify-start lg:justify-end w-full max-w-full lg:max-w-[600px] z-50 pointer-events-auto">
              <Magnetic>
                <a href="#philosophy" className="btn-premium hover-target bg-text-100 text-bg-base border-transparent hover:text-text-100 hover:bg-transparent hover:border-text-100 text-center flex justify-center text-xs px-4 py-2">
                  <span className="relative z-10">Philosophy</span>
                </a>
              </Magnetic>
              <Magnetic>
                <a href="#experience" className="btn-premium hover-target bg-text-100 text-bg-base border-transparent hover:text-text-100 hover:bg-transparent hover:border-text-100 text-center flex justify-center text-xs px-4 py-2">
                  <span className="relative z-10">Experience</span>
                </a>
              </Magnetic>
              <Magnetic>
                <a href="#capabilities" className="btn-premium hover-target bg-text-100 text-bg-base border-transparent hover:text-text-100 hover:bg-transparent hover:border-text-100 text-center flex justify-center text-xs px-4 py-2">
                  <span className="relative z-10">Capabilities</span>
                </a>
              </Magnetic>
              <Magnetic>
                <a href="#projects" className="btn-premium hover-target bg-text-100 text-bg-base border-transparent hover:text-text-100 hover:bg-transparent hover:border-text-100 text-center flex justify-center text-xs px-4 py-2">
                  <span className="relative z-10">Case Studies</span>
                </a>
              </Magnetic>
              <Magnetic>
                <a href="#transmission" className="btn-premium hover-target bg-text-100 text-bg-base border-transparent hover:text-text-100 hover:bg-transparent hover:border-text-100 text-center flex justify-center text-xs px-4 py-2">
                  <span className="relative z-10">Transmission</span>
                </a>
              </Magnetic>
              <Magnetic>
                <a 
                  href="mailto:ameenkido5412@gmail.com"
                  className="btn-premium hover-target bg-text-100 text-bg-base border-transparent hover:text-text-100 hover:bg-transparent hover:border-text-100 text-center flex justify-center text-xs px-4 py-2"
                >
